...
void menu(int c,Grafo g1,Grafo_Matriz g2,Grafok g3,int max)
{
	system ("cls");
	float var_x;
	int n;
...
int main()
{
	...
	float k;
	sello();
	cout<<"Ingrese cantidad de vertices del grafo: ";
	cin>>k;
	c=static_cast<int>(k);
	if(c>0)
	{
